...
from hoodapp.models import Neighborhood, Profile,Business,Location,Category,Post
from .forms import BusinessForm, ProfileForm, NeighborhoodForm,PostForm
from hoodapp import forms           
...
def neighborhood(request):
    ...
    return render(request, 'main/places.html', {'neighborhood': neighborhood})
...
def create_business(request):
    ...
    if request.method == "POST":
        ...
        form = BusinessForm()
    return render(request, "main/businesses.html", {"business": business, 'form':form})
